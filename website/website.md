...
- [linux 软件包查询](https://pkgs.org/) 可以查询所需要的包的依赖以及安装方式
- [github](https://github.com)
- [gitee](https://gitee.com)
- [Docker Hub](https://hub.docker.com/)
- [npm 中国](https://www.npmmirror.com/)

## 2 运维部署编排

- [Docker -- 从入门到实践](https://yeasy.gitbook.io/docker_practice/)
- [Kubernetes 中文社区中文文档](http://docs.kubernetes.org.cn/)
- [Kubernets 官网](https://kubernetes.io/zh/)
...
- [阿里云sdk](https://developer.aliyun.com/sdk/java.html)
- [加速下载github文件](https://toolwa.com/github/)
- [加速下载github文件](https://ghproxy.com/)
- [sourceforge](https://sourceforge.net)
- [绿色资源网](https://zcjun.com/)
- [插件小屋 Chrome插件](https://www.chajianxw.com/)
- [极简插件 Chrome插件](https://chrome.zzzmh.cn/#/search)
- [离线下载 Chrome插件](https://crxdl.com/)
- [扩展派 Chrome插件](https://www.crxfun.com/)
- [JDK搜搜下载](http://www.sousou88.com/spec/java.html)
- [JDK华为镜像下载](https://repo.huaweicloud.com/java/jdk/)

## 3 资源-工具类

- [数据牌](https://shields.io/)
- [钉钉网页版](https://im.dingtalk.com/)
- [JSON 解析](https://www.json.cn/)
- [书栈网](https://www.bookstack.cn/)
- [gitee 图书/手册/教程](https://gitee.com/explore/ebooks-manual?page=2)
- [拓跋阿秀/CS-Books](https://gitee.com/ForthEspada/CS-Books)
- [几百本常用电子书链接](https://github.com/XiangLinPro/IT_book)
- [程序员笔记](https://www.knowledgedict.com/)
- [Data Structure Visualizations](https://www.cs.usfca.edu/~galles/visualization/Algorithms.html) 算法演示
- [框架基测](https://web-frameworks-benchmark.netlify.app/result)

## 4 文档类

- [git emoji](https://gitmoji.js.org/)
- [nginx-rtmp 文档](https://github.com/arut/nginx-rtmp-module/wiki/Directives)
- [nginx-http-flv 文档](https://github.com/winshining/nginx-http-flv-module/blob/master/README.CN.md)
...
- [python-docx](https://www.osgeo.cn/python-docx/index.html)
- [python-docx-template’s documentation](https://docxtpl.readthedocs.io/en/latest/#)
- [loguru](https://loguru.readthedocs.io/en/stable/overview.html) 日志库
- [typer](https://typer.tiangolo.com/) Python 命令行工具
...
- [gino](https://python-gino.org) PostgreSQL
