...
docker exec dev_study_rabbitmq_12 /bin/bash -c 'rabbitmqctl join_cluster --ram rabbit@myRabbitmq-11'
...
docker exec dev_study_rabbitmq_13 /bin/bash -c 'rabbitmqctl join_cluster --ram rabbit@myRabbitmq-11'
