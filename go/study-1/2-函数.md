...
func main() {
    ...
    name_1, hp_1 := generate()
    name_2, hp_2 := generate()
    name_3, hp_3 := generate()

    fmt.Println(name_1, hp_1)
    fmt.Println(name_2, hp_2)
    fmt.Println(name_3, hp_3)

    generate2 := playerGen2()
    name_11, hp_11 := generate2("pandora")
    name_12, hp_12 := generate2("athena")
    name_13, hp_13 := generate2("pan")

    fmt.Println(name_11, hp_11)
    fmt.Println(name_12, hp_12)
    fmt.Println(name_13, hp_13)
}
...
发生 panic 后，程序会从调用 panic 的函数位置或发生 panic 的地方**立即返回**
